...
Function InitTeamByGameFeedConnection(teamCode As String) As Object

    conn = CreateObject("roAssociativeArray")
    conn.UrlShowFeed  = "http://www4.hockeystreams.com/rss/roku_demand.php?team=" + teamCode

    conn.Timer = CreateObject("roTimespan")

    conn.LoadTeamGamesFeed    = load_gamesByTeam_feed
    conn.ParseShowFeed   = parse_gamesByTeam_feed
    conn.InitFeedItem    = init_gamesByTeam_item
...
'******************************************************
Function newGamesByTeamFeed() As Object
...
'***********************************************************
Function init_gamesByTeam_item() As Object
...
'*********************************************************
Function load_gamesByTeam_feed(conn As Object) As Dynamic
...
'**************************************************************************
'**************************************************************************
Function parse_gamesByTeam_feed(xml As Object, feed As Object) As Void
